            ...
            <div class="widget-content p-0">
              <div class="widget-content-wrapper">
                <div class="widget-content-left">
                  <div class="btn-group">
                    <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                      ...
                      <x-form method="POST" :action="route('admin.logout')">
                ...
                <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn d-flex">
                  <div>
                    <img width="42" class="rounded-circle img-fluid" src="{{ Avatar::create(auth()->guard('admin')->user()->name)->toBase64() }}" alt="{{ auth()->guard('admin')->user()->name }}">
                    <i class="fa fa-angle-down ml-2 opacity-8"></i>
                  </div>
                </a>
                <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn text-left d-flex">
                  <div class="widget-content-left  ml-3 header-user-info">
                    <div class="widget-heading">
                      {{ auth()->guard('admin')->user()->name }}
                    </div>
                    <div class="widget-subheading">
                      {{ auth()->guard('admin')->user()->getMainRole() }}
                    </div>
                  </div>
                </a>
